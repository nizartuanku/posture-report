...
```
curl -LO https://github.com/nizartuanku/posture-report/releases/latest/download/posture-report-free-0.1.2-linux-amd64.tar.gz
curl -LO https://github.com/nizartuanku/posture-report/releases/latest/download/SHA256SUMS
sha256sum -c SHA256SUMS
tar xzf posture-report-free-0.1.2-linux-amd64.tar.gz && cd posture-report-0.1.2 && ./posturereport -dir /var/lib/hexward
```
